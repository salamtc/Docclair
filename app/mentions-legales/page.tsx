      ...
      <main className="mx-auto w-full max-w-2xl px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <div className="rounded-xl border border-stone-200 bg-white p-5 space-y-1.5">
              <p><span className="font-medium text-gray-900">Dénomination sociale :</span> DocClair SAS</p>
              <p><span className="font-medium text-gray-900">Forme juridique :</span> Société par Actions Simplifiée</p>
              <p><span className="font-medium text-gray-900">SIRET :</span> En cours d&apos;immatriculation</p>
              ...
              <p><span className="font-medium text-gray-900">Directeur de la publication :</span> Le représentant légal de DocClair SAS</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="rounded-xl border border-stone-200 bg-white p-5 space-y-1.5">
              ...
              <p><span className="font-medium text-gray-900">Adresse :</span> 340 Pine Street, Suite 701, San Francisco, CA 94104, États-Unis</p>
              <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">Intelligence artificielle</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">Données personnelles</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">Droit applicable</h2>
            <p>
