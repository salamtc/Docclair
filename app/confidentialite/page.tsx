    ...
    <div className="flex flex-1 flex-col bg-stone-50">
      ...
      <main className="mx-auto w-full max-w-2xl px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">1. Responsable du traitement</h2>
            <p>
              ...
              <a href="mailto:contact@docclair.fr" className="text-blue-600 hover:underline">contact@docclair.fr</a>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">5. Sous-traitants et transferts</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">6. Vos droits</h2>
